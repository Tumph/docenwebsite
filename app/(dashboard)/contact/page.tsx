    ...
    <main className='h-screen bg-black'>
        ...
        <div className='h-full w-full flex flex-col items-center justify-center text-white gap-4 text-center'>
          ...
          <h2 className='text-xl md:text-4xl max-w-4xl w-4/5 md:w-full'>
            Reach out with any inquiries and we&apos;ll get back to you with <span className='bg-gradient-to-br to-green-700 from-green-300 text-transparent bg-clip-text'>everything you need.</span>
          </h2>
